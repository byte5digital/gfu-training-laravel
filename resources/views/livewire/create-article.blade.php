<div wire:ignore.self class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="createArticleModal" id="createArticleModal" aria-hidden="true">
